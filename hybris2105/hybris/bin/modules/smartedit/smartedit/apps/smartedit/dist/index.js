...
function angularJSDecoratorCustomElementClassFactory(upgrade, nodeUtils, componentName) {
    return /** @class */ (function (_super) {
        ...
        class_1.prototype.internalConnectedCallback = function () {
             ...
             * externalSlotDisabledDecorator doesn't have CONTENT_PLACEHOLDER, add
             * if to fix the console error.
             */
            if ('externalSlotDisabledDecorator' !== componentName) {
 ...
 * Copyright (c) 2021 SAP SE or an SAP affiliate company. All rights reserved.
 */
var SE_DECORATIVE_BODY_PADDING_LEFT_CLASS = '.se-decorative-body__padding--left';
var SE_DECORATIVE_BODY_PADDING_RIGHT_CLASS = '.se-decorative-body__padding--right';
var SE_DECORATIVE_PANEL_AREA_CLASS = '.se-decorative-panel-area';
var SE_DECORATIVE_BODY_AREA_CLASS = '.se-decoratorative-body-area';
...
var SlotContextualMenuDecoratorComponent = /** @class */ (function (_super) {
    ...
    function SlotContextualMenuDecoratorComponent(element, yjQuery, systemEventService, contextualMenuService, nodeUtils) {
        ...
        _this.positionPanelHorizontally = lodash.throttle(_this.positionPanelHorizontally, THROTTLE_DELAY);
    ...
    SlotContextualMenuDecoratorComponent.prototype.getRightMostOffsetFromPage = function () {
        var $decorativePanel = this.yjQuery(this.element.nativeElement).find(SE_DECORATIVE_PANEL_AREA_CLASS);
    ...
    SlotContextualMenuDecoratorComponent.prototype.positionPanelVertically = function () {
        var decorativePanelArea = this.yjQuery(this.element.nativeElement).find(SE_DECORATIVE_PANEL_AREA_CLASS);
        var decoratorPaddingContainer = this.yjQuery(this.element.nativeElement).find(SE_DECORATIVE_BODY_AREA_CLASS);
        var marginTop;
        var height = decorativePanelArea.height();
        var marginTopOffset = -32;
