...
import './ActionableSearchItemComponent.scss';

export interface ActionableSearchItem {
    /** Event Id to publish by {@link SystemEventService}. */
    eventId?: string;
    /** Action button label. */
    actionText?: string;
}
...
/**
 * Component displayed when there is no search results for given string in {@link SelectComponent}.
 *
 * Contains of text and the Action Button which can be clicked by a user to publish
 * specified Event Id by {@link SystemEventService}.
 *
