...
public class GeneratedCommerceServicesConstants
{
	...
	public static class Attributes
	{
		...
		public static class BaseSite
		{
			...
			public static final String PRODUCTINDEXTYPE = "productIndexType".intern();
		...
		public static class BaseStore
		{
			...
			public static final String PICKUPINSTOREMODE = "pickupInStoreMode".intern();
			public static final String PRODUCTINDEXTYPE = "productIndexType".intern();
			public static final String PRODUCTSEARCHSTRATEGY = "productSearchStrategy".intern();
			public static final String SOLRFACETSEARCHCONFIGURATION = "solrFacetSearchConfiguration".intern();
		...
		public static class SnIndexType
		{
			public static final String SITES = "sites".intern();
			public static final String STORES = "stores".intern();
		}
	...
	public static class Relations
	{
		...
		public static final String SNBASESITE2INDEXTYPE = "SnBaseSite2IndexType".intern();
		public static final String SNBASESTORE2INDEXTYPE = "SnBaseStore2IndexType".intern();
