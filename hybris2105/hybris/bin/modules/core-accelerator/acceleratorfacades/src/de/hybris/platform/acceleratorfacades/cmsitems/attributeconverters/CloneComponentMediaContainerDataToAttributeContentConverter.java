		...
		implements Converter<Map<String, Object>, MediaContainerModel>
{
	...
	public MediaContainerModel convert(final Map<String, Object> source)
	{
		...
		MediaContainerModel mediaContainerModel = getMediaContainerFacade().createMediaContainer();
		if (cloneComponentModel != null && cloneComponentModel.getMedia(Locale.forLanguageTag(languageTag)) != null)
		{
			mediaContainerModel = cloneComponentModel.getMedia(Locale.forLanguageTag(languageTag));
		}
		...
		if (Objects.nonNull(source.get(MediaContainerModel.QUALIFIER)))
		{
			mediaContainerModel.setQualifier(source.get(MediaContainerModel.QUALIFIER).toString());
		}
	...
	{
		if (!MapUtils.isEmpty(srcAttributeMap))
		{
