...
public class GenericConditionQueryBuilderTest
{
	...
	@Test
	public void shouldReturnOperatorsIsNullAndEmptyWhenSearchWithIsEmptyForHandleUnaryOperatorAndStringType()
	{
		// given
	...
	@Test
	public void shouldReturnOperatorsIsNotNullAndNotEmptyWhenSearchWithIsNotEmptyForHandleUnaryOperatorAndStringType()
	{
		// given
		prepareDataAttribute(DataType.STRING);
	...
	@Test
	public void shouldReturnOperatorsIsNullAndEmptyWhenSearchWithIsEmptyAndAttributeTypeIsString()
	{
		// given
		prepareDataAttribute(DataType.STRING);
	...
	@Test
	public void shouldReturnOperatorsIsNotNullAndNotEmptyWhenSearchWithIsNotEmptyAndAttributeTypeIsString()
	{
		// given
		prepareDataAttribute(DataType.STRING);
	...
	public void shouldSearchForGraterDateWithGrater()
	{
		...
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_EQUALS_COMPARES_EXACT_DATE, "true");
	...
	public void shouldSearchForExactDateWithRoundingUpToSecondWithEqualsFollowAllOperatorConfig()
	{
		...
		final HashMap<String, String> editorParameters = new HashMap<>();
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_COMPARES_EXACT_DATE, "true");
		when(attributeDescriptor.getEditorParameters()).thenReturn(editorParameters);
	...
	public void shouldSearchForExactDateWithRoundingUpToSecondWithEquals()
	{
		...
		final HashMap<String, String> editorParameters = new HashMap<>();
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_EQUALS_COMPARES_EXACT_DATE, "true");
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_COMPARES_EXACT_DATE, "false");
		when(attributeDescriptor.getEditorParameters()).thenReturn(editorParameters);
	...
	public void shouldSearchForExactDateInViewTypes()
	{
		...
		when(attributeDescriptor.getAttributeName()).thenReturn(DATE_TYPE_ATTRIBUTE);
		final HashMap<String, String> editorParameters = new HashMap<>();
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_EQUALS_COMPARES_EXACT_DATE, "false");
		editorParameters.put(com.hybris.backoffice.cockpitng.search.builder.impl.GenericConditionQueryBuilder.EDITOR_PARAM_COMPARES_EXACT_DATE, "false");
		when(attributeDescriptor.getEditorParameters()).thenReturn(editorParameters);
