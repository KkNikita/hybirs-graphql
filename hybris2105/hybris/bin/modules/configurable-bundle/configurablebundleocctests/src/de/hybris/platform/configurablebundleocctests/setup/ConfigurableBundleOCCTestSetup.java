...
public class ConfigurableBundleOCCTestSetup extends CommercewebservicesTestSetup
{
	public void loadData()
	{
		...
		if (BundleTestSetupUtils.enableAutoPick()) {
			getSetupImpexService().importImpexFile("/configurablebundleocctests/import/sampledata/productCatalogs/wsTestProductCatalog/products-bundles-autopick.impex", false);
		}
