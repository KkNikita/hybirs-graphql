 ...
 */
@IntegrationTest
class ODataFilterExpressionIntegrationTest extends ServicelayerSpockSpecification {

    private static final String TEST_NAME = "ODataFilterExpression"
    private static final String IO = "${TEST_NAME}_IO"
    private static final String DEFAULT_CATALOG = "${TEST_NAME}_Default"
    ...
    def setupProduct() {
        importImpEx(
                ...
                "                            ; ${DEFAULT_CATALOG}        ; Staged",
                "                            ; ${DEFAULT_CATALOG}        ; Online"
        )
    }
    ...
    def "can filter by navigation property integrationKey"() {
        given:
        importImpEx(
                "\$stagedVersion = ${DEFAULT_CATALOG}:Staged",
                "\$onlineVersion = ${DEFAULT_CATALOG}:Online",
                'INSERT_UPDATE Product; code[unique = true]; catalogVersion(catalog(id), version)',
                '                     ; prod1              ; $stagedVersion',
                '                     ; prod2              ; $onlineVersion',
                '                     ; prod3              ; $onlineVersion')
        def context = oDataContextForProducts(['$filter': "catalogVersion/integrationKey eq 'Staged|$DEFAULT_CATALOG'"])
    ...
    def "cannot filter navigation property integration key with operator #operator other than eq"() {
        ...
        importImpEx(
                ...
                '                     ; prod2              ; $onlineVersion',
                '                     ; prod3              ; $onlineVersion')
        def context = oDataContextForProducts(['$filter': "catalogVersion/integrationKey $operator 'Staged|$DEFAULT_CATALOG'"])
    ...
    def "can filter by localized property using the default language system [en]"() {
        ...
        importImpEx(
                ...
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Staged                                     ; Product One",
                "                     ; prod2              ; ${DEFAULT_CATALOG}:Staged                                     ; Product Two",
                'INSERT_UPDATE Product; code[unique = true]; catalogVersion(catalog(id), version)[unique = true]; name[lang=de]',
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Staged                                     ; Produkt Eins")
    ...
    def "can filter by localized property name[lang=#acceptLanguage] = #filterValue"() {
        ...
        def context = oDataContextForProducts(['$filter': "name eq $filterValue"], acceptLanguage)
    ...
    def 'can filter by simple property when it has same name in integration object as in type system'() {
        ...
        importImpEx(
                ...
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Staged ",
                "                     ; prod2              ; ${DEFAULT_CATALOG}:Online ",
                "                     ; prod2              ; ${DEFAULT_CATALOG}:Staged ")
    ...
    def 'can filter by navigation property that has different name in IO compared to the name in the type system'() {
        ...
        importImpEx(
                ...
                "                      ; cat1               ; ${DEFAULT_CATALOG}:Staged",
                "                      ; cat2               ; ${DEFAULT_CATALOG}:Staged",
                'INSERT_UPDATE Product; code[unique = true]; supercategories(code); $catalogVersion[unique = true]',
                "                     ; prod1              ; cat1                 ; ${DEFAULT_CATALOG}:Staged",
                "                     ; prod2              ; cat2                 ; ${DEFAULT_CATALOG}:Staged")
    ...
    def "can filter by nested key entity property: catalogVersion/version #operator #rightOperand"() {
        ...
        importImpEx(
                ...
                "                            ; ${DEFAULT_CATALOG}        ; aVersion                ; true",
                "                            ; ${DEFAULT_CATALOG}        ; bVersion                ; true",
                "                            ; ${DEFAULT_CATALOG}        ; cVersion                ; true",

                'INSERT_UPDATE Product; code[unique = true]; catalogVersion(catalog(id), version)[unique = true]',
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Staged",
                "                     ; prod2              ; ${DEFAULT_CATALOG}:Online",
                "                     ; prod3              ; ${DEFAULT_CATALOG}:aVersion",
                "                     ; prod4              ; ${DEFAULT_CATALOG}:bVersion",
                "                     ; prod5              ; ${DEFAULT_CATALOG}:cVersion")

        expect:
        def context = oDataContextForProducts(['$filter': "catalogVersion/version $operator $rightOperand", '$top': 100])
        ODataResponse response = facade.handleRequest(context)
        def json = extractEntitiesFrom response
    ...
    def "filter expression can contain '#operator' operator"() {
        ...
        importImpEx(
                'INSERT_UPDATE Product; code[unique = true]; catalogVersion(catalog(id), version)[unique = true]',
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Staged ",
                "                     ; prod1              ; ${DEFAULT_CATALOG}:Online ",
                "                     ; prod2              ; ${DEFAULT_CATALOG}:Staged ")
        def context = oDataContextForProducts(['$filter': "catalogVersion/integrationKey eq 'Staged|$DEFAULT_CATALOG' $operator code eq 'prod1'"])
        ...
        where:
        operator | result
        'and'    | ["Staged|$DEFAULT_CATALOG|prod1" as String]
        'or'     | ["Staged|$DEFAULT_CATALOG|prod1" as String, "Online|$DEFAULT_CATALOG|prod1" as String, "Staged|$DEFAULT_CATALOG|prod2" as String]
    }
    ...
    def "filter is ignored when used with get an entity by ID"() {
        ...
        importImpEx(
                'INSERT_UPDATE Product; code[unique = true]; catalogVersion(catalog(id), version)[unique = true]',
                "                     ; pr                 ; ${DEFAULT_CATALOG}:Staged")
        def context = oDataContextForProducts("Staged|$DEFAULT_CATALOG|pr", ['$filter': "code eq 'prod1'"])
    ...
    def "reports error when attempting to filter on non-existing property: #filterExpr"() {
        ...
        where:
        filterExpr << ["catalogVersion-integrationKey eq 'Staged|$DEFAULT_CATALOG'",
                       "code eq 'prod1' and catalogVersion-integrationKey eq 'Staged|$DEFAULT_CATALOG'"]
    }
    ...
    def "can filter by navigation property that has one to many relation: pricerow/price #operator 4"() {
        ...
        importImpEx(
                ...
                '$catalogVersion=catalogVersion(catalog(id), version)',
                'INSERT_UPDATE Product;code[unique=true]; $catalogVersion[unique = true ]; $prices',
                "                     ;prod1            ; $DEFAULT_CATALOG:Staged        ; 1 pieces = 3 USD N",
                "                     ;prod2            ; $DEFAULT_CATALOG:Staged        ; 1 pieces = 5 USD N")
    ...
    def "can filter on property with many-to-many relationship by #property"() {
        ...
        importImpEx(
                ...
                "                      ; cat1               ; $DEFAULT_CATALOG:Staged",
                "                      ; cat2               ; $DEFAULT_CATALOG:Staged",
                'INSERT_UPDATE Product; code[unique = true]; $catalogVersion[unique = true]; supercategories(code)',
                "                     ; prod1              ; $DEFAULT_CATALOG:Staged       ; cat1",
                "                     ; prod2              ; $DEFAULT_CATALOG:Staged       ; cat1, cat2")
    ...
    def "can filter on property with many-to-many relationship by name when more than 1 item with name is found"() {
        ...
        importImpEx(
                ...
                "                      ; cat1               ; sameName; $DEFAULT_CATALOG:Staged",
                "                      ; cat2               ; sameName; $DEFAULT_CATALOG:Staged",
                'INSERT_UPDATE Product; code[unique = true]; $catalogVersion[unique = true]; supercategories(code)',
                "                     ; prod1              ; $DEFAULT_CATALOG:Staged       ; cat1",
                "                     ; prod2              ; $DEFAULT_CATALOG:Staged       ; cat1, cat2")
    ...
    def "can filter on property with many-to-many relationship, one-to-many relationship, and simple property"() {
        ...
        importImpEx(
                ...
                'INSERT_UPDATE Product; code[unique = true]; $catalogVersion[unique = true]; supercategories(code)',
                "                     ; prod1              ; $DEFAULT_CATALOG:Staged       ; cat1",
                "                     ; prod2              ; $DEFAULT_CATALOG:Staged       ; cat2")
        def context = oDataContextForProducts(['$filter': "catalogVersion/integrationKey eq 'Staged|$DEFAULT_CATALOG' and code eq 'prod2' or supercategories/integrationKey eq 'cat1'"])
    ...
    def "can filter reverse direction many-to-many relationship by #property"() {
        ...
        where:
        property         | value
        "integrationKey" | "Staged|$DEFAULT_CATALOG|prod1"
        "code"           | "prod1"
    }
    ...
    def "filter products by creation time: filter=#left #operator #right"() {
        given:
        importImpEx(
                "INSERT_UPDATE Product; code[unique = true]; creationtime[dateformat=yyyy-MM-dd HH:mm:ss.SSS]; catalogVersion(catalog(id), version)[default = ${DEFAULT_CATALOG}:Staged]",
        ...
        where:
        left                                                                   | operator | right                                                                  | result
        "creationtime"                                                         | "eq"     | convertTimeZone("datetime", "2020-02-10T16:33:12.100")                 | ["Staged|"+DEFAULT_CATALOG+"|prod0"]
        "creationtime"                                                         | "eq"     | convertTimeZone("datetime", "2020-02-10T16:33:12.10")                  | ["Staged|"+DEFAULT_CATALOG+"|prod0"]
        "creationtime"                                                         | "eq"     | convertTimeZone("datetime", "2020-02-10T16:33:12.1")                   | ["Staged|"+DEFAULT_CATALOG+"|prod0"]
        "creationtime"                                                         | "ge"     | convertTimeZone("datetime", "2020-02-10T16:33:12.10")                  | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "gt"     | convertTimeZone("datetime", "2020-02-10T16:33:12.1")                   | ["Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "gt"     | convertTimeZone("datetime", "2020-02-10T16:33:12")                     | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "gt"     | convertTimeZone("datetime", "2020-02-10T16:33:1")                      | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "ge"     | convertTimeZone("datetime", "2020-02-11T16:33")                        | ["Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "ge"     | convertTimeZone("datetime", "2020-02-11T16:3")                         | ["Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        "creationtime"                                                         | "eq"     | convertTimeZone("datetime", "2020-02-11T16:3")                         | []
        "creationtime"                                                         | "lt"     | convertTimeZone("datetime", "2020-02-13T16:33:12.133")                 | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2"]
        "creationtime"                                                         | "le"     | convertTimeZone("datetime", "2020-02-13T16:33:12.133")                 | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2", "Staged|"+DEFAULT_CATALOG+"|prod3"]
        convertTimeZone("creationtime gt datetime", "2020-02-10T16:33:12.100") | "and"    | convertTimeZone("creationtime lt datetime", "2020-02-12T16:33:12.122") | ["Staged|"+DEFAULT_CATALOG+"|prod1"]
        convertTimeZone("creationtime ge datetime", "2020-02-10T16:33:12.100") | "and"    | convertTimeZone("creationtime le datetime", "2020-02-12T16:33:12.122") | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod1", "Staged|"+DEFAULT_CATALOG+"|prod2"]
        convertTimeZone("creationtime eq datetime", "2020-02-10T16:33:12.100") | "or"     | convertTimeZone("creationtime eq datetime", "2020-02-12T16:33:12.122") | ["Staged|"+DEFAULT_CATALOG+"|prod0", "Staged|"+DEFAULT_CATALOG+"|prod2"]
    }

    @Test
    @Issue('https://jira.tools.sap/browse/CXEC-7485')
    def "can filter navigation property that has many to many relation and combined with order by"() {
        given:
        importImpEx(
                '$catalogVersion=catalogVersion(catalog(id), version)',
                'INSERT_UPDATE Category; code[unique = true]; $catalogVersion[unique = true]',
                ...
                "                     ; prod1              ; $DEFAULT_CATALOG:Staged       ; cat1",
                "                     ; prod2              ; $DEFAULT_CATALOG:Staged       ; cat1, cat2")
        def context = oDataContextForProducts(['$filter': "supercategories/code eq 'cat1'", '$orderby': "code desc"])
        ...
        then:
        def json = extractEntitiesFrom response
        json.getCollectionOfObjects("d.results[*].code") == ["prod2", "prod1"]
    }
    ...
    ODataContext oDataContextForProducts(Map params, String language) {
        def request = ODataRequestBuilder.oDataGetRequest()
                ...
                .withParameters(stringValueMap(params))
    ...
    Map<String, String> stringValueMap(Map map) {
        map.collectEntries { [(it.key): it.value as String] } as Map<String, String>
    }
}
