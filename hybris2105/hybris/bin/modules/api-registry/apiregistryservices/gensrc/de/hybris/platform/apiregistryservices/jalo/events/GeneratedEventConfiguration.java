...
public abstract class GeneratedEventConfiguration extends GenericItem
{
	...
	/** Qualifier of the <code>EventConfiguration.filterLocation</code> attribute **/
	...
	**/
	...
	/**
	 * <i>Generated method</i> - Getter of the <code>EventConfiguration.filterLocation</code> attribute.
	...
	{
		return (String)getProperty( ctx, FILTERLOCATION);
	}
	...
	/**
	 * <i>Generated method</i> - Setter of the <code>EventConfiguration.filterLocation</code> attribute. 
	...
	{
		setProperty(ctx, FILTERLOCATION,value);
	}
