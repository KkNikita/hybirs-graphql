 ...
 */
package org.commerce.v2.config;


import de.hybris.platform.servicelayer.config.ConfigurationService;
import de.hybris.platform.webservicescommons.swagger.services.ApiVendorExtensionService;
import org.commerce.constants.YcommercewebservicesConstants;
import org.commerce.request.mapping.handler.CommerceHandlerMapping;
...
{
	private static final String PASSWORD_AUTHORIZATION_SCOPE = "mockcommercewebservices.oauth2.password.scope";
	private static final String CLIENT_CREDENTIAL_AUTHORIZATION_SCOPE = "mockcommercewebservices.oauth2.clientCredentials.scope";
	private static final String AUTHORIZATION_URL = "mockcommercewebservices.oauth2.tokenUrl";

	private static final String DESC = "mockcommercewebservices.v2.description";
	private static final String TITLE = "mockcommercewebservices.v2.title";
	private static final String VERSION = "mockcommercewebservices.v2.version";
	private static final String LICENSE = "mockcommercewebservices.v2.license";
	private static final String LICENSE_URL = "mockcommercewebservices.v2.license.url";
	...
	private static final String LEGACY_CONTENT_NEGOTIATION = "mockcommercewebservices.content.negotiation.legacy";
